          ...
          <div className="flex justify-between">
            ...
            {github ? (
              ...
              <span className="relative group cursor-not-allowed">
                ...
                <span className="font-mono absolute right-0 top-full z-50 w-40 max-w-[85vw] rounded-lg bg-white dark:bg-slate-900 text-neutral-700 dark:text-neutral-200 text-xs px-4 py-2 shadow-lg opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-300">
                  Private repository
                </span>
              </span>
            )}
